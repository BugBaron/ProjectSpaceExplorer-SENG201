...
public class TextGameEnvironment {
	...
	private TextInOutHandler inOut;
	...
	public static void main(String[] args) {
		TextGameEnvironment gameEnvironment = new TextGameEnvironment();
	 ...
	 */
	public TextGameEnvironment() {
		inOut = new TextInOutHandler();
	}
	...
	/**
	 * Selects a crew member to view or complete an action.
	 */
	...
	/**
	 * Completes an action for a crew member.
	 * @param crewMember the crew member to make do an action
	 */
