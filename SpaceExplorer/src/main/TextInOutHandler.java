...
/**
 * Handles all input and output sent to it, for the TextGameEnvironment.
 * @author Daniel Harris and Rebekah McKinnon
 */
public class TextInOutHandler {
	private Scanner scanner;
	
	/**
	 * Creates a new TextInOutHandler with System.in as the input and
	 * with System.out as the output
	 */
	public TextInOutHandler() {
