...
public class OldGUIWindow {
	...
	public static void main(String[] args) {
		EventQueue.invokeLater(new Runnable() {
			public void run() {
				try {
					OldGUIWindow window = new OldGUIWindow();
	...
	private void initialize() {
		...
		lblImageControlPanel.setIcon(new ImageIcon(OldGUIWindow.class.getResource("/images/SPACE.PNG")));
		...
		lblImageShipStatus.setIcon(new ImageIcon(OldGUIWindow.class.getResource("/images/SPACE.PNG")));
		...
		lblImageVisitOutpost.setIcon(new ImageIcon(OldGUIWindow.class.getResource("/images/OUTPOST.png")));
		...
		lblImageInventoryScreen.setIcon(new ImageIcon(OldGUIWindow.class.getResource("/images/STORAGE.PNG")));
